...
RUN set -eux; \
    ...
    case "$fedoraArch" in \
        ...
        'aarch64') \
            ...
            ;; \
        *) echo >&2 "error: unsupported 'docker.tgz' architecture ($fedoraArch)"; exit 1 ;; \
    esac; \
    \
...
RUN set -eux; \
    ...
    case "$fedoraArch" in \
        ...
        'aarch64') \
            ...
            ;; \
        *) echo >&2 "warning: unsupported 'docker-buildx' architecture ($fedoraArch); exit 1" ;; \
    esac; \
    \
...
RUN set -eux; \
    ...
    case "$fedoraArch" in \
        ...
        'aarch64') \
            ...
            ;; \
        *) echo >&2 "warning: unsupported 'docker-compose' architecture ($fedoraArch); exit 1" ;; \
    esac; \
    \
